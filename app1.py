...
def main():
    ...
    st.sidebar.markdown(
        """ Developed by Shailendra Dubey:
        Email  : shailendradubey114@gmail.com/
        [LinkedIn] (https://www.linkedin.com/in/shailendra-d-96402912a/) /
        [Medium]  (https://shailendra114.medium.com/) /
        [GitHub] (https://github.com/Shailendra114)""")
